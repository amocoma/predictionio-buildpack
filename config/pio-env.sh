...
if [ -z "${FOUNDELASTICSEARCH_URL}" ]; then
  export PIO_STORAGE_SOURCES_ELASTICSEARCH_CLUSTERNAME=elasticsearch-pio
  export PIO_STORAGE_SOURCES_ELASTICSEARCH_HOSTS=localhost
  export PIO_STORAGE_SOURCES_ELASTICSEARCH_PORTS=9300
    ...
    export PIO_STORAGE_SOURCES_ELASTICSEARCH_CLUSTERNAME=${arrIN[0]}
    export PIO_STORAGE_SOURCES_ELASTICSEARCH_HOSTS=host
    export PIO_STORAGE_SOURCES_ELASTICSEARCH_PORTS=80
fi
