...
PIO_STORAGE_REPOSITORIES_METADATA_NAME=pio_meta
PIO_STORAGE_REPOSITORIES_METADATA_SOURCE=ELASTIC
PIO_STORAGE_REPOSITORIES_EVENTDATA_NAME=pio_event
PIO_STORAGE_REPOSITORIES_EVENTDATA_SOURCE=PGSQL
PIO_STORAGE_REPOSITORIES_MODELDATA_NAME=pio_model
PIO_STORAGE_REPOSITORIES_MODELDATA_SOURCE=PGSQL
...
PIO_STORAGE_SOURCES_ELASTIC_TYPE=elasticsearch
PIO_STORAGE_SOURCES_ELASTIC_HOSTS=6d09461a72125d0fc9d6cd817015142c.eu-west-1.aws.found.io
PIO_STORAGE_SOURCES_ELASTIC_PORTS=9300
PIO_STORAGE_SOURCES_ELASTIC_CLUSTERNAME=6d09461a72125d0fc9d6cd817015142c
ES_CONF_DIR=${PIO_HOME}/vendors/elasticsearch-${ELASTICSEARCH_VERSION}
